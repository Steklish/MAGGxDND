...
# Database path
DB_PATH = Path("C:/VS_Code/MAGGxDND/data/maggxdnd.db")
...
import subprocess
result = subprocess.run(['dir', '/s', '/b', 'data\\maggxdnd.db'], shell=True, capture_output=True, text=True, cwd=r'C:\VS_Code\MAGGxDND')
