...
from backend.src.services import character_profile_service
from backend.src.schema.character_profile import CharacterProfileCreate, CharacterProfileUpdate, CharacterProfileInDB
