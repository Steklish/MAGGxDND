...
from core.schemas.orchestration import Event, EventList, EventTypes
from core.game.manipulators.base_manipulation import Archive, BaseManipulation
from core.game.manipulators.melee_attack_manipulation import MeleeAttackBreakdown, MeleeAttackManipulator
...
class Manipulator:
    ...
    def _execute_event(self, event: Event) -> List[Event]:
        ...
        self.logger.warning(f"No manipulator found for event type: {event.event_type} {event.__dict__}")
        return []
